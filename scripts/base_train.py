...
parser.add_argument("--medusa-independent", action="store_true", help="DEPRECATED: use --medusa-delta instead")
parser.add_argument("--medusa-delta", action="store_true", help="use hidden-space delta Medusa heads (fast, reuses lm_head with fused CE)")
...
while True:
    ...
    if args.eval_every > 0 and (last_step or step % args.eval_every == 0):
        ...
        with autocast_ctx:
            val_bpb, val_ce = evaluate_bpb(model, val_loader, eval_steps, token_bytes)
