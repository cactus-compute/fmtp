"""Profile forward pass cost for different tree sizes."""
import torch
import time
...
print("="*60)
print("Profiling MTP generation loop components:")
print("="*60)
...
# Profile _evaluate_candidates_greedy_fast (uses result from one forward)
